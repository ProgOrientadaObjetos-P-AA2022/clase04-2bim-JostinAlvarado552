    ...
    public static void main(String[] args) {
        ...
        while (bandera) {
            ...
            if (tipoAutomovil == 1) {
                ...
                System.out.println("Ingresela Galones totales a comprar");
                galmax = entrada.nextInt();
                System.out.println("Ingrese el costo de cada galon");
                costoGalon = entrada.nextDouble();
                automovilG.establecerNombrePropietario(nombresPr);
                ...
                System.out.println("Ingresela litros totales a comprar");
                ...
                automovilD.establecerNombrePropietario(nombresPr);
        ...
        for (int i = 0; i < automoviles.size(); i++) {
            automoviles.get(i).establecerValorCancelar();

            System.out.printf("Datos Automoviles\n -----------------------------"
                    + "----------------------------------------------\n"
                    + "%s\n",
                    automoviles.get(i));
        }
